      ...
      <br/>
        ...
        <form autoComplete='off' className='login-form-group' onSubmit={handleLogin}>
          <div className='loginform-title'>
           ...
           <br />
           <button onClick={signInWithGoogle} className="login-form-login-google"><img src={google} className="loginform-google-icon"/><p>Zaloguj się Przez Google</p></button>
 <br/> 
           <div className='login-form-link-to-register'>
           <span>Nie masz konta?</span>
           <br/>
           <Link to="/Register" className='login-form-register'>Rejestracja</Link>
           </div>
